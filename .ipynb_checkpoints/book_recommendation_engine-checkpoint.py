...
def check_and_award_badge(student_id):
    try:
        # Get the current directory and build the path to the database dynamically
        project_root = os.path.dirname(os.path.abspath(__file__))
        db_path = os.path.join(project_root, 'data', 'Apsbdb')
        
        # Connect to SQLite database using the dynamic path
